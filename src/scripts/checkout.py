...
from src.config.constants import CHECKIN_RANDOM_MARGIN, CHECKOUT_RANDOM_MARGIN, TELEGRAM_NOTIFICATIONS, CHECKOUT_MESSAGE
...
def random_checkout():
    sleep(randint(CHECKIN_RANDOM_MARGIN, CHECKOUT_RANDOM_MARGIN if CHECKIN_RANDOM_MARGIN <=
          CHECKOUT_RANDOM_MARGIN else CHECKIN_RANDOM_MARGIN))
    checkout()
